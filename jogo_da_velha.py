...
def drawBoard(board):
	...
	#O quadro é uma lista de 9 strings representando o qaudro
...
def inputPlayerLetter():
	...
	while not(letter == 'X' or letter == 'O'):
		...
		if(letter != 'X' and letter != 'O'):
			print("Entre apenas com a letra X se voce quer ser X ou com a letra O se voce quer ser O!")
